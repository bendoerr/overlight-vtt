  ...
  protected activateListeners(html: JQuery) {
    ...
    $(html)
      ...
      .on("click", (event) => {
        event.preventDefault();
        event.stopPropagation();
        const a = new game.overlight.dialogs.RollCombatTestDialog();
        a.render();
      });
    ...
    $(html)
      ...
      .on("click", (event) => {
        event.preventDefault();
        event.stopPropagation();
        const a = new game.overlight.dialogs.RollWealthTestDialog();
        a.render();
      });
    ...
    $(html)
      ...
      .on("click", (event) => {
        event.preventDefault();
        event.stopPropagation();
        const a = new game.overlight.dialogs.RollChromaTestDialog();
        a.render();
      });
  }
  /** @override */
