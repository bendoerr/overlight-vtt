  ...
  glob("src/module/{actor,item}s/**/*.ts", (e, fileNames) => {
    ...
    fileNames
      ...
      .forEach((e) => {
        ...
        adds.push(
          e.sheet
            ? `${e.type}s.registerSheet("overlight-vtt", ${e.hashedName}.sheet, { makeDefault: true, types: ${e.hashedName}.types });`
    ...
    const ends = [
      "export const OverlightItem = proxy(items, Item) as typeof Item",
      "export const OverlightActor = proxy(actors, Actor) as typeof Actor",
      "",
    ];
